...
public class AntPathMatcherUtil {
     ...
     * @since 4.1
     */
    public AntPathMatcherUtil(String pathSeparator) {
    ...
    public String[] tokenizeToStringArray(String str, String delimiters, boolean trimTokens, boolean ignoreEmptyTokens) {
        ...
        return (!CollectionUtil.isEmpty(tokens) ? tokens.toArray(EMPTY_STRING_ARRAY) : EMPTY_STRING_ARRAY);
    }
}
